<template>
    <b-container fluid class="L_LAYOUTS L_LAYOUT_13">
        <b-row no-gutters>
        ...
        <b-row no-gutters class="content-rows">
            ...
            <b-col md="9" class="slot-container">
...
<script>
    import layoutLifecycle from '@/services/layoutLifecycle.js'

    export default {
        name: 'L_LAYOUT_13',
        extends: layoutLifecycle,
    }
</script>
